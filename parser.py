...
#     if not total_pages:
#         return[]
#     file_name=url.replace("https://www.sigmaaldrich.com/SG/en/products/","").replace("/","_")
#     os.makedirs("html_pages", exist_ok=True)
#     file_path = f"html_pages/{file_name}.html.gz"
#
#
#
...
#
#
#     return extract_data(tree,url)
#
#
# def extract_data(tree,url):
#     raw = tree.xpath('//script[@id="__NEXT_DATA__"]/text()')
#
#     data = json.loads(raw[0])
#
...
#         res = requests.get(page_url, headers=headers, timeout=60)
...
def extract_data(tree, url, total_pages):
    ...
    # page 1 — already fetched, no extra request
    ...
    # pages 2-N in parallel with retry
    if total_pages > 1:
